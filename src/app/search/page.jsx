            ...
            >
                ...
                <div className="w-full md:w-1/4">
                    <button
                        type="submit"
                        disabled={isLoading}
                        className="w-full h-12 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white font-bold tracking-wide rounded-xl shadow-md shadow-red-200 hover:shadow-lg hover:shadow-red-300 transition-all flex items-center justify-center gap-2 duration-200 disabled:opacity-50"
                    >
                        <svg
